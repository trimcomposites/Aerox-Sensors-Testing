...
class SetSensorTimestampUseCase extends AsyncUseCaseWithParams<void,  RacketSensor>{

  final BleRepository bleRepository;

  SetSensorTimestampUseCase({required this.bleRepository});
  @override
  Future<EitherErr<void>> call( sensor ) async {
    
    return bleRepository.setTimestamp( sensor );
