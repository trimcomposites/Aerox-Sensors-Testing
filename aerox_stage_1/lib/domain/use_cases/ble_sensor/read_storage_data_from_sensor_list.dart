...
class ReadStorageDataFromSensorListUsecase
    extends AsyncUseCaseWithParams<void, ReadBlobsFromSensorListParams> {
  final BleRepository bleRepository;
  final BlobSQLiteDB blobSQLiteDB; //TODO: DELETE, solo para mocks
  ReadStorageDataFromSensorListUsecase(
      {required this.bleRepository, required this.blobSQLiteDB});
  @override
  Future<EitherErr<Map<RacketSensor, List<Blob>>>> call(
      ReadBlobsFromSensorListParams params) {
