...
class SaveCommentUsecase extends AsyncUseCaseWithParams<void, Comment>{

  final CommentsRepository commentsRepository;

  SaveCommentUsecase({required this.commentsRepository});

  @override
  Future<EitherErr<void>> call(Comment comment) async {
    return await commentsRepository.saveComment(comment);
  }
